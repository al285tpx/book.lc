...
class main extends ACore {
    ...
    public function get_content() {
        ...
        //здесь вместо FOR будет While который будет передовать данные классу groupdel
        //через GET
        /**$row = array();
        ...
        **/
        ...
        printf( "</div>
        <div><button id='button'>Удалить выбранные</button></div>
        <div id='popup'><p>Подтвердить удаление</p><p> <input name='item[]' type= 'submit' value='Удалить выбраные'></p></div>
        <div id='hover'></div>    
        </div>");
