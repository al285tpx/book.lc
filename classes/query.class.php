...
abstract class query{
    ...
    protected function articles_all($link){
        // Формируем запрос
    ...
    protected function article_get($link, $id_article){
    ...
    protected function articles_new($link, $title, $year, $author, $col_str){
        // Подготовка
        $title = trim($title);
        $author = trim($author);
    ...
    protected function articles_edit($link, $id, $title, $year, $author, $col_str){
    ...
    protected function articles_delete($link, $id){
        $id = (int)$id;
        // Проверка
        if ($id == 0)
            return false;
    ...
    protected function articles_intro($text, $len = 500)
    {
